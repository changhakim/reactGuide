import Style from './WithdrawRegister.module.scss';
import  { ReactComponent as ArrowDown}  from '@styles/assets/images/icon/icon-arrow-down12.svg';
import  { ReactComponent as ArrowUp}  from '@styles/assets/images/icon/icon-arrow-up-24.svg';
import { useState, useCallback } from 'react';
import React, { cloneElement, Children } from 'react'; 

const WithdrawRegister = ()=>{ 
    ...
    const unRegistData = [
        ...
        const handleOnchangeAll = useCallback((e)=>{ 
            if(!e.target.checked){
                ...
                let temp =[];
                data.map((e)=>{ return temp.push(e.acctNo)});
                setCheckedList(temp);
            }
        },[checkedList]);
...
export default WithdrawRegister;